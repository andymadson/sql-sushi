...
.venv/bin/python -m pip install -r requirements-dev.txt -r chapter_12_scheduling_sql_pipelines_python/requirements.txt -r chapter_13_workflow_orchestration/requirements.txt
.venv/bin/python chapter_13_workflow_orchestration/scripts/run_scheduled_pipeline.py --log-file chapter_13_workflow_orchestration/logs/manual-run.log
```
...
.\.venv\Scripts\python.exe -m pip install -r requirements-dev.txt -r chapter_12_scheduling_sql_pipelines_python\requirements.txt -r chapter_13_workflow_orchestration\requirements.txt
.\.venv\Scripts\python.exe chapter_13_workflow_orchestration\scripts\run_scheduled_pipeline.py --log-file chapter_13_workflow_orchestration\logs\manual-run.log
```
...
Windows uses Task Scheduler rather than cron. From the repo root, after the virtual environment exists and dependencies are installed, run:
